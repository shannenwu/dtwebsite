...
class NavBar extends Component {
  ...
  render() {
    const { open } = this.state;
    const { userInfo, logout, showBg } = this.props;
    return (
      <nav className={showBg ? "navbar light" : "navbar dark"}>
        ...
        <div className="logo" onClick={() => this.handleItemClick("/")}>
          <img
            src={
              showBg
                ? "/site_images/dtlogo-white.png"
                : "/site_images/dtlogo-black.png"
            }
            alt=""
          />
        </div>
        <ul className={open ? "main-nav active" : "main-nav"} id="js-menu">
          ...
          <li>
            <div
              className="nav-links"
              onClick={() => this.handleItemClick("/officers")}
            >
              OFFICERS
            </div>
          </li>
          <li>
            <div
              className="nav-links"
              onClick={() => this.handleItemClick("/auditions")}
            >
              AUDITIONS
            </div>
          </li>
          <li>
            <div
              className="nav-links"
              onClick={() => this.handleItemClick("/shows")}
            >
              SHOWS
            </div>
          </li>
