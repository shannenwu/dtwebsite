...
const Auditions = () => (
  <div className='static-page'>
    <h1>Auditions</h1>
    <p>
      DanceTroupe auditions are divided between a Saturday and Sunday at the beginning of each term. For Spring 2019, they will be held on February 9th and 10th. Auditions are a laid-back, fun process, so nothing should stop you from auditioning!
    </p>
    <h3>Saturday</h3>
    <p>
